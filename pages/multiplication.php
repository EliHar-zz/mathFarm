...
<html lang="en">
    <head>
	<meta charset="UTF-8" />
	<title> Math Farm - Multiplication</title>
...
?>
	...
	<section>
		<script type="text/javascript">operation = "x"</script>
		
		<div style="padding: 10px 40px 70px 70px">
			<form action="#" id="myForm">
				<h1 style="color: #e7f29c;"><br>Let's practice Multiplication</h1>
				...
				<label style="font-family: arial;"><input class="number" type="text" readonly id="num1"/> x </label>
				...
				<input class="button" type="reset" value="Clear" id="clear"/><br><br>
				
				<label id="declaration"></label><label> You've just collected <input class="score" type="text" placeholder="0" readonly id="correctAnswer"/> point(s).</label><br><br>

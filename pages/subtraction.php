...
<html lang="en">
    <head>
	<meta charset="UTF-8" />
	<title> Math Farm - Subtraction</title>
...
?>
	...
	<section>
		<script type="text/javascript">operation = "-"</script>
		
		<div style="padding: 10px 40px 70px 70px">
			<form action="#" id="myForm">
				<h1 style="color: #e7f29c;"><br>Let's practice Subtraction</h1>
				...
				<label><input class="number" type="text" readonly id="num1"/> - </label>
